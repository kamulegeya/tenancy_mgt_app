...
public class CreateReceiptTask extends AsyncTask<String, Integer, HtmlFile>{
    ...
    public CreateReceiptTask(File storageFolder, OnTaskFinishedListener taskFinishedListener,Context c) {
    ...
    protected HtmlFile doInBackground(String... params) {
        ...
        try {
            ...
            // Store the file
            File file = createTempFile(folder, "receipt.pdf");
    ...
    private  void addTitlePage(Document document,String name)
    	    ...
    	    preface.add(new Paragraph("Acknowledgement of Receipt of Rent",smallBold1));
